...
import { Plus, Trash2, Save, Info, ChevronDown, ChevronRight, RotateCcw, FileDown, AlertCircle, Sparkles, Globe, Share2, FolderOpen, FilePlus, Upload, Copy, X, Edit3, BookOpen, Send, Link as LinkIcon } from "lucide-react";
          ...
          <div className="flex items-center justify-between flex-wrap gap-2 sm:gap-3">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap">
              ...
              <button onClick={() => setShowSharePanel(true)}
                ...
                <Send size={14} /> <span className="hidden sm:inline">{t("shareProject")}</span>
              </button>
              {/* 使用说明 */}
              <a href={guideHref} target="_blank" rel="noopener noreferrer"
                className="btn-interact flex items-center gap-1.5 px-2.5 sm:px-3 py-2 text-xs font-medium border rounded-sm"
