...
const DICT = {
  ...
  productsHint: { zh: "点击行展开编辑。成本、售价、平台费、仓费均按“上架销售单位”填写：6只装按整套，L12按整套12件，壶杯套装按整套；正式报价后需替换。", en: "Click a row to edit. Costs, list price and fees are per sellable listing unit, e.g. a 6-pack or 12-piece set, not per individual cup.", ru: "Нажмите на строку для редактирования. Цена и расходы указаны за продаваемую единицу/набор, не за отдельный стакан." },
  ...
  projectSkuCount: { zh: "{n} 个SKU", en: "{n} SKUs", ru: "{n} SKU" },
  ...
  calcLabeling: { zh: "+ 贴标/本地化", en: "+ Labeling / Localization", ru: "+ Маркировка / локализация" },
  calcUnitCost: { zh: "= 销售单位成本", en: "= Sellable Unit Cost", ru: "= Себест. ед. продажи" },
  calcUnitPayout: { zh: "销售单位回款", en: "Sellable Unit Payout", ru: "Выплата/ед. продажи" },
